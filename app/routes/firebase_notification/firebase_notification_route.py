...
def assign_firebase_notification_roles(app) -> None:
    base_url = f"{RoutePathConstants.BasePathName}/firebase-notification"
    ...
    assign_roles_to_route(
        app=app,
        path=f"{base_url}/client/create-or-update",
        roles=[
            RoleRouteConstant.AdministratorTagName,
            RoleRouteConstant.ClientTagName,
        ],
