...
class BookingFieldPartyAndPaymentTransactionFilter(BaseFilter[BookingFieldPartyAndPaymentTransactionEntity]):
    """
    Фильтр для связей между бронированиями площадок и платежными транзакциями.
