...
class PaymentTransactionStatusPaginationFilter(BasePaginationFilter[PaymentTransactionStatusEntity]):
    def __init__(
        self,
        per_page: int = AppQueryConstants.StandardPerPageQuery(
            "Количество статусов на странице"
        ),
        ...
        super().__init__(
            model=PaymentTransactionStatusEntity,
            search=search,
            order_by=order_by,
