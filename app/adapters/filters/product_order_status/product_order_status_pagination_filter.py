...
class ProductOrderStatusPaginationFilter(BasePaginationFilter[ProductOrderStatusEntity]):
    def __init__(
        ...
        super().__init__(
            model=ProductOrderStatusEntity,
            search=search,
            order_by=order_by,
