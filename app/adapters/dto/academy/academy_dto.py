...
class AcademyCDTO(BaseModel):
    ...
    is_active: DTOConstant.StandardBooleanTrueField(
        description="Флаг активности академии"
    )
...
class AcademyUpdateDTO(BaseModel):
    ...
    title_ru: (
        DTOConstant.StandardVarcharField(description="Название академии на русском")
        | None
    ) = None
    title_kk: (
    ...
    average_price: (
        DTOConstant.StandardNullableDecimalField(description="Средняя цена") | None
    ) = None
    ...
    tik_tok: DTOConstant.StandardNullableVarcharField(description="TikTok") | None = (
        None
    )
