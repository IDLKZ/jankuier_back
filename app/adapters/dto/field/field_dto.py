...
class FieldCDTO(BaseModel):
    image_id: DTOConstant.StandardNullableUnsignedIntegerField(description="ID главного изображения поля")
    ...
    title_kk: DTOConstant.StandardNullableVarcharField(description="Название поля на казахском")
    title_en: DTOConstant.StandardNullableVarcharField(description="Название поля на английском")
    description_ru: DTOConstant.StandardNullableTextField(description="Описание поля на русском")
    description_kk: DTOConstant.StandardNullableTextField(description="Описание поля на казахском")
    description_en: DTOConstant.StandardNullableTextField(description="Описание поля на английском")
...
class FieldUpdateDTO(BaseModel):
    ...
    image_id: DTOConstant.StandardNullableUnsignedIntegerField(description="ID главного изображения поля") | None = None
    city_id: DTOConstant.StandardNullableUnsignedIntegerField(description="ID города") | None = None
    title_ru: DTOConstant.StandardVarcharField(description="Название поля на русском") | None = None
    title_kk: DTOConstant.StandardNullableVarcharField(description="Название поля на казахском") | None = None
    title_en: DTOConstant.StandardNullableVarcharField(description="Название поля на английском") | None = None
    description_ru: DTOConstant.StandardNullableTextField(description="Описание поля на русском") | None = None
    description_kk: DTOConstant.StandardNullableTextField(description="Описание поля на казахском") | None = None
    description_en: DTOConstant.StandardNullableTextField(description="Описание поля на английском") | None = None
    ...
    is_active: DTOConstant.StandardBooleanTrueField(description="Флаг активности поля") | None = None
    has_cover: DTOConstant.StandardBooleanFalseField(description="Наличие крыши") | None = None
