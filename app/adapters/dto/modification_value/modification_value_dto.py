...
class ModificationValueCDTO(BaseModel):
    modification_type_id: DTOConstant.StandardUnsignedIntegerField(
    ...
    title_ru: DTOConstant.StandardVarcharField(
        description="Название значения модификации на русском"
    )
    title_kk: DTOConstant.StandardNullableVarcharField(
        description="Название значения модификации на казахском"
    )
    title_en: DTOConstant.StandardNullableVarcharField(
        description="Название значения модификации на английском"
    )
    description_ru: DTOConstant.StandardNullableTextField(
        description="Описание значения модификации на русском"
    )
    description_kk: DTOConstant.StandardNullableTextField(
        description="Описание значения модификации на казахском"
    )
    description_en: DTOConstant.StandardNullableTextField(
        description="Описание значения модификации на английском"
    )
    is_active: DTOConstant.StandardBooleanTrueField(
        description="Флаг активности значения модификации"
    )
...
class ModificationValueUpdateDTO(BaseModel):
    ...
    title_ru: (
        DTOConstant.StandardVarcharField(
            description="Название значения модификации на русском"
        )
        | None
    ) = None
    ...
    is_active: (
        DTOConstant.StandardBooleanTrueField(
            description="Флаг активности значения модификации"
        )
        | None
    ) = None
