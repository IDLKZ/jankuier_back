...
class PaginationAcademyMaterialRDTO(BasePageModel):
    items: list[AcademyMaterialRDTO]


class PaginationAcademyMaterialWithRelationsRDTO(BasePageModel):
    items: list[AcademyMaterialWithRelationsRDTO]
