...
class TicketonOrderStatusDTO(BaseModel):
...
class TicketonOrderStatusCDTO(BaseModel):
...
class TicketonOrderStatusRDTO(TicketonOrderStatusDTO):
    previous_id: DTOConstant.StandardNullableUnsignedIntegerField(
        description="ID предыдущего статуса"
    )
    next_id: DTOConstant.StandardNullableUnsignedIntegerField(
...
class TicketonOrderStatusWithRelationsRDTO(TicketonOrderStatusRDTO):
    previous_status: "TicketonOrderStatusRDTO | None" = None
    next_status: "TicketonOrderStatusRDTO | None" = None
