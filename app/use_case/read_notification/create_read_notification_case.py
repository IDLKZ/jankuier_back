...
class CreateReadNotificationCase(BaseUseCase[ReadNotificationWithRelationsRDTO]):
    """
    Use Case для создания записи о прочитанном уведомлении.
    """
    ...
    async def validate(self, dto: ReadNotificationCDTO) -> None:
        ...
        # Проверка, что пользователь еще не прочитал это уведомление
        ...
        self.model = ReadNotificationEntity(**dto.dict())
