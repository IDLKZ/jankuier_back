...
from app.adapters.dto.product_order_item_status.product_order_item_status_dto import ProductOrderItemStatusCDTO, ProductOrderItemStatusRDTO
...
class CreateProductOrderItemStatusCase(BaseUseCase[ProductOrderItemStatusRDTO]):
    ...
    async def validate(self, dto: ProductOrderItemStatusCDTO) -> None:
        ...
        self.model = ProductOrderItemStatusEntity(**dto.dict())