...
class CreateFieldPartyScheduleSettingsCase(BaseUseCase[FieldPartyScheduleSettingsWithRelationsRDTO]):
    ...
    Использует:
        ...
        - DTO `FieldPartyScheduleSettingsCDTO` для входных данных.
    ...
    Атрибуты:
        ...
        model (FieldPartyScheduleSettingsEntity | None): Созданная модель настроек расписания.
    """
    ...
    async def execute(self, dto: FieldPartyScheduleSettingsCDTO) -> FieldPartyScheduleSettingsWithRelationsRDTO:
        ...
        Args:
            dto (FieldPartyScheduleSettingsCDTO): Данные для создания настроек расписания.

        Returns:
            FieldPartyScheduleSettingsWithRelationsRDTO: Созданные настройки расписания с связями.
    ...
    async def validate(self, dto: FieldPartyScheduleSettingsCDTO) -> None:
        """
        Валидация перед выполнением.

        Args:
            dto (FieldPartyScheduleSettingsCDTO): Данные для валидации.
        ...
        if dto.active_start_at >= dto.active_end_at:
            raise AppExceptionResponse.bad_request(
    ...
    async def transform(self, dto: FieldPartyScheduleSettingsCDTO) -> None:
        """
        Преобразование DTO в модель.

        Args:
            dto (FieldPartyScheduleSettingsCDTO): Данные для преобразования.
        """
        self.model = FieldPartyScheduleSettingsEntity(**dto.dict())