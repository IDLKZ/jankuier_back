...
from app.adapters.filters.field_party_schedule_settings.field_party_schedule_settings_filter import FieldPartyScheduleSettingsFilter
...
class AllFieldPartyScheduleSettingsCase(BaseUseCase[list[FieldPartyScheduleSettingsWithRelationsRDTO]]):
    """
    ...
    async def execute(self, filter: FieldPartyScheduleSettingsFilter) -> list[FieldPartyScheduleSettingsWithRelationsRDTO]:
        """
        ...
        return [FieldPartyScheduleSettingsWithRelationsRDTO.from_orm(model) for model in models]
