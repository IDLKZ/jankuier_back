...
from app.adapters.dto.product_order_status.product_order_status_dto import ProductOrderStatusRDTO, ProductOrderStatusCDTO
...
class UpdateProductOrderStatusCase(BaseUseCase[ProductOrderStatusRDTO]):
    def __init__(self, db: AsyncSession) -> None:
        self.repository = ProductOrderStatusRepository(db)
        self.model: ProductOrderStatusEntity | None = None

    async def execute(self, id: int, dto: ProductOrderStatusCDTO) -> ProductOrderStatusRDTO:
