...
class AllAcademyGroupSchedulesCase(BaseUseCase[list[AcademyGroupScheduleWithRelationsRDTO]]):
    """
    ...
    async def execute(self, filter: BaseFilter) -> list[AcademyGroupScheduleWithRelationsRDTO]:
        """
        ...
        return [AcademyGroupScheduleWithRelationsRDTO.from_orm(model) for model in models]
